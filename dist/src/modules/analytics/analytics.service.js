...
export const getWeeklyRevenue = async (merchantId) => {
    ...
    const currentRevenue = currentWeekTransactions.reduce((sum, tx) => sum + tx.amount, 0);
    const previousRevenue = previousWeekTransactions.reduce((sum, tx) => sum + tx.amount, 0);
